...
from .models import TipoTransaccion, Transaccion, TipoDenominacion, Denominaciones, DetalleTransaccion
...
admin.site.register(TipoDenominacion)
admin.site.register(Denominaciones)
