...
from .views import ListarTransacciones, obtener_listas_transacciones_json, ViewCrearTransaccion, efectuar_transaccion, DetailTransaccion
...
urlpatterns = [
    ...
    path('inventario/editar_producto_inventario/<int:pk>', EditarProductoInventario.as_view(), name='edit_prod_inv'),
    ...
    path('ventas/crear_transaccion', ViewCrearTransaccion.as_view(), name="crear_trans"),
    path('ventas/detalle_transaccion/<int:pk>', DetailTransaccion.as_view(), name="detalle_trans"),
    path('ventas/lista_transacciones_json', obtener_listas_transacciones_json, name="list_trans_json"),
    path('ventas/efectuar_transaccion_json', efectuar_transaccion, name="efectuar_trans_json"),
