...
class AperturaCorte(models.Model):
    ...
    corte_global=models.BooleanField(help_text="Servira para establecer que es el ultimo corte del dia y no se tomara en cuenta a la hora de realizar nueva apertura se asumira que la apertura anterior es cero", null=True, blank=True)
